...
from dgc_gnn import models
from dgc_gnn.data.dataset_loaders import init_data_loader
from dgc_gnn.utils.loss import compute_loss
from dgc_gnn.utils.metrics import compute_metrics_batch
...
class MatcherTrainer(pl.LightningModule):
    ...
    def training_step(self, data, batch_idx):
        ...
        loss = losses["loss"]
        self.log('train_loss', losses, on_epoch=True, logger=True, batch_size=16)
